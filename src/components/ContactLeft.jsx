...
const ContactLeft = () => {
  return (
    <div
      className="relative p-6 sm:p-8 border-2 border-[#00ffcc] bg-black bg-opacity-20 backdrop-blur-lg shadow-lg 
                      cut-corner hover:shadow-[0_0_20px_5px_rgba(0,255,204,0.5)] transition-all duration-500 max-w-full sm:max-w-md md:max-w-lg lg:max-w-xl"
    >
      {/* Holographic Glow */}
